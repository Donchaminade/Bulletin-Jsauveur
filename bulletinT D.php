...
?>
 ...
 <!-- ECM -->
            ...
            <tr>
                ...
                <td>2</td>
                <td><?php echo ($moyenneAll !== null && $noteCompAll !== null) ? number_format(floor((floatval($noteCompAll) + floatval($moyenneAll)) / 2 * 2 * 100) / 100, 2, ',', ' ') : ''; ?></td>
            ...
            <tr>
                ...
                <td>4</td>
                <td><?php echo number_format(floor((floatval($noteCompSVT) + floatval($moyenneSVT)) / 2 * 4 * 100) / 100, 2, ',', ' '); ?></td>
