...
<head>
    ...
    <header class="premium-header no-print">
        <div style="display: flex; gap: 15px;">
            ...
            <a href="1ere A4.html" class="nav-link back">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Calcul du total des coefficients (Base 19 pour les matières obligatoires restantes)
    ...
    $sommeMoyennes = (
        ...
        ((($moyennePhilo + $noteCompPhilo) / 2) * 3) +
...
?>
 ...
 <!-- ECM -->
            ...
            <tr>
                ...
                <td>3</td>
                <td><?php echo number_format(floor((floatval($noteCompPhilo) + floatval($moyennePhilo)) / 2 * 3 * 100) / 100, 2, ',', ' '); ?></td>
            ...
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format((($noteCompPhysique + $moyennePhysique)/2)* 1,2);?></td>
