    ...
    <style>
                body {
                    ...
                    .container::before {
                        ...
                        background-size: 90%; /* Ajustez la taille du filigrane */
                ...
                .header img {
                    max-width: 135px; /* Taille de l'image */
                    display: block;
                    margin-left: 90px;
                }
                ...
                th, td {
                    padding: 3px; /* Espacement plus uniforme */
...
<a id="backButton" href="1ere A4.html" class="button no-print">
...
?>
    ...
    <td colspan="11" style="text-align: center; font-weight: bold; border-top: 1px solid black; padding: 5px;">MATIERES LITTERAIRES</td>
            ...
            <tbody>
                <tr>
                    ...
                    <td>4</td>
                    <td><?php echo number_format((($noteCompFrancaise + $moyenneFrancaise)/2) * 4,2);?></td>
 ...
 <!-- ECM -->
            ...
            <tr>
                ...
                <td>3</td>
                <td><?php echo number_format((($noteCompPhilo + $moyennePhilo)/2) * 3,2);?></td>
               ...
               <td><?php echo $profCompAll; ?></td>
                ...
                <tr>
                    ...
                    <td>3</td>
                    <td><?php echo number_format((($noteCompAnglais + $moyenneAnglais)/2) * 3,2);?></td>
            ...
            <tr>
                ...
                <td>3</td>
                <td><?php echo number_format((($noteCompHistoireGeo + $moyenneHistoireGeo)/2) * 3,2);?></td>
            ...
            <tr>
                ...
                <td>2</td>
                <td><?php echo number_format ((($noteCompMath + $moyenneMath)/2)* 2,2);?></td>
            ...
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format((($noteCompSVT + $moyenneSVT)/2)* 1,2);?></td>
