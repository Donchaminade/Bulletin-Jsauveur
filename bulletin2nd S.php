...
<a id="backButton" href="2nde S.html" class="button no-print">
...
?>
 ...
 <!-- ECM -->
            ...
            <tr>
                ...
                <td>4</td>
                <td><?php echo number_format ((($noteCompMath + $moyenneMath)/2)* 4,2);?></td>
            ...
            <tr>
                ...
                <td>3</td>
                <td><?php echo number_format((($noteCompSVT + $moyenneSVT)/2)* 3,2);?></td>
