...
<a id="backButton" href="T A4.html" class="button no-print">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sommeMoyennes = (
        ((($noteCompFrancaise + $moyenneFrancaise) / 2) * 3) +
        ...
        ((($moyennePhilo + $noteCompPhilo) / 2)* 4)+ //philo
...
?>
    ...
    <td colspan="11" style="text-align: center; font-weight: bold; border-top: 1px solid black; padding: 5px;">MATIERES LITTERAIRES</td>
            ...
            <tbody>
                <tr>
                    ...
                    <td>3</td>
                    <td><?php echo number_format((($noteCompFrancaise + $moyenneFrancaise)/2) * 3,2);?></td>
 ...
 <!-- ECM -->
            ...
            <tr>
                ...
                <td>4</td>
                <td><?php echo number_format((($noteCompPhilo + $moyennePhilo)/2) * 4,2);?></td>
