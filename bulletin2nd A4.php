...
<head>
    ...
    <style>
                ...
                .container::before {
                        ...
                        width: 100%;
                        height: 100%;
                        /* background removed for PDF clarity */
...
<body>
    <header class="premium-header no-print">
        <div style="display: flex; gap: 15px;">
            ...
            <a href="2nde A4.html" class="nav-link back">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sommeMoyennes = (
        ...
        ((($moyennePhilo + $noteCompPhilo) / 2)* 3)+ //philo
    ...
    // Nettoyage du nom de la classe pour le fichier (ex: 2nde A4 -> 2nde_A4)
...
?>
 ...
 <!-- ECM -->
            ...
            <tr>
                <td>Musique/EM/Ewe/Kabye/Couture/<br>Esp/Dessin</td>
