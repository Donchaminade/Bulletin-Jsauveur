...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $totalcoef = 8 + (float)$coef + (float)$coefE;

    // Calcul de la somme des moyennes avec coefficients
    $sommeMoyennes = (
        ((($noteCompFrancaise + $moyenneFrancaise) / 2) * 2) +
        ((($noteCompAnglais + $moyenneAnglais) / 2) * 1) +
        ((($noteCompHistoireGeo + $moyenneHistoireGeo) / 2) * 1) +
        ((($noteCompECM + $moyenneECM) / 2) * 1) +
        ((($noteCompMath + $moyenneMath) / 2) * 1) +
    ...
    // Nettoyage du nom de la classe pour le fichier (ex: 6ème -> 6eme)
...
?>
      ...
      <div class="container">
        ...
        <table>
            <tr>
                ...
                <td><strong>Trimestre:</strong> <?php echo $trimestre; ?></td>
    ...
    <td colspan="11" style="text-align: center; font-weight: bold; border-top: 1px solid black; padding: 5px;">MATIERES LITTERAIRES</td>
            ...
            <tbody>
                <tr>
                    ...
                    <td><?php echo number_format(floor((floatval($moyenneFrancaise) + floatval($noteCompFrancaise)) / 2 * 100) / 100, 2, ',', ' '); ?></td>
                    <td>2</td>
 ...
 <!-- ECM -->
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format(floor((floatval($noteCompECM) + floatval($moyenneECM)) / 2 * 1 * 100) / 100, 2, ',', ' '); ?></td>
               ...
               <td><?php echo $profCompECM; ?></td>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td><?php echo number_format(floor((floatval($noteCompAnglais) + floatval($moyenneAnglais)) / 2 * 1 * 100) / 100, 2, ',', ' '); ?></td>
            ...
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format(floor((floatval($noteCompHistoireGeo) + floatval($moyenneHistoireGeo)) / 2 * 1 * 100) / 100, 2, ',', ' '); ?></td>
    ...
    <td colspan="11" style="text-align: center; font-weight: bold; border-top: 1px solid black; padding: 5px;">MATIERES SCIENTIFIQUES</td>
            ...
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format(floor((floatval($noteCompMath) + floatval($moyenneMath)) / 2 * 1 * 100) / 100, 2, ',', ' '); ?></td>
...
<div>
        ...
        &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; Observations: .............................. &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;Decision finale:.................................<br>
            ...
            <div style="display: ;">
                    <p> &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;Adétikopé, le ……/……/ ………&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;Directeur: &nbsp;<?php echo '    '. ' '.$directeur?></p>
            </div>
        <br>
        <br>
</div>
