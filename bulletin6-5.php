...
?>
 ...
 <!-- ECM -->
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format((($noteCompECM + $moyenneECM)/2) * 1,2);?></td>
               ...
               <td><?php echo $profCompECM; ?></td>
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td><?php echo number_format((($noteCompAnglais + $moyenneAnglais)/2) * 1,2);?></td>
            ...
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format((($noteCompHistoireGeo + $moyenneHistoireGeo)/2) * 1,2);?></td>
    ...
    <td colspan="11" style="text-align: center; font-weight: bold; border-top: 1px solid black; padding: 5px;">MATIERES SCIENTIFIQUES</td>
            ...
            <tr>
                ...
                <td>1</td>
                <td><?php echo number_format ((($noteCompMath + $moyenneMath)/2)* 1,2);?></td>
