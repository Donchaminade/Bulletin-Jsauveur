...
<body>
    <header class="premium-header no-print">
        <div style="display: flex; gap: 15px;">
            ...
            <a href="4-3ème.html" class="nav-link back">
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $totalcoef = 17 + (float)$coef + (float)$coefE;
    ...
    // Nettoyage du nom de la classe pour le fichier (ex: 4ème -> 4eme)
 ...
 <!-- ECM -->
    ...
    <td colspan="11" style="text-align: center; font-weight: bold; border-top: 1px solid black; padding: 5px;">MATIERES SCIENTIFIQUES</td>
            ...
            <tr>
                ...
                <td>3</td>
                <td><?php echo number_format(floor((floatval($noteCompMath) + floatval($moyenneMath)) / 2 * 3 * 100) / 100, 2, ',', ' '); ?></td>
            ...
            <tr>
                ...
                <td>2</td>
                <td><?php echo number_format(floor((floatval($noteCompSVT) + floatval($moyenneSVT)) / 2 * 2 * 100) / 100, 2, ',', ' '); ?></td>
